...
Идентификатор сообщения, формируется как текущее время в миллисекундах и рандомные 6 цифр.
Рандомные 6 цифр приписываются для того, чтобы уменьшить вероятность коллизии идентификаторов.
> Пример: если сообщение было создано в момент времени `1529356853606`, а рандомные 6 цифр были `028029`, то идентификатор сообщения будет `"1529356853606028029"`.
